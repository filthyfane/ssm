...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		$text = <<<EOD
Denumirea: SC WORK PROTECTION BUSINESS SRL
Sediu: București, Aleea Ariniș, Nr. 1, Bl. OD1, Ap. 90, Sector 1
Cod Poștal: 062031, Tel: 0745.134.989
Cod unic de înregistrare: 26783100
Număr de înregistrare în Registrul Comerțului: J40/3943/2010
EOD;
		
        $this->Multicell(0, 20, $text, 0, 'L');
...
//var_dump(KIK_PLUGIN_ABSPATH.'plugins/tcpdf/fonts/fa-regular-400.ttf');
//$fontname = $pdf->addTTFfont(KIK_PLUGIN_ABSPATH.'plugins/tcpdf/fonts/fa-regular-400.ttf', ‘TrueTypeUnicode', '', 32);
...
//$pdf->Output($path.'example_048.pdf', 'F');
